        ...
        <div class="main-container-login" id="main-container-login">
            ...
            <div class="credentials">
                ...
                <div class="show_password">
                    &nbsp<input title="show password toggle" type="checkbox" onclick="showPassword()"> &nbsp <small>Show Password</small>
                </div>

                <!-- FORGOT PASSWORD -->
                <a title="Move to forgot password page" class="forgot-password" href="forgot_password.php">Forgot your password?</a>

                <!-- LOGIN BUTTON -->
                <div class="btn-container">
                    <input title="Login" name="submit" type="button" value="Login" class="login-submit-btn">
                </div>
            ...
            <div class="form_description_container">
                ...
                <div class="form_description">
                    ...
                    <div class="btn-container">
                        ...
                        <button title="Move to Sign-up form" class="btn-signup" onclick="toggleLoginSignupForm(1)">SignUp</button>
                    </div>
                </div>
            </div>
        </div>
