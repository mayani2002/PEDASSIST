...
<?php include('assets/headernav.php'); ?>
    ...
    <main>
        ...
        <section class="facts" id="2">
            <div class="right_align" data-aos="fade-right" >
                <blockquote class="container">“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ante imperdiet lacus, semper libero habitant elit, donec sed. Lorem ipsum dolor sit amet, consectetur.”
                </blockquote>
            ...
            <div class="left_align" data-aos="fade-left">
                <blockquote class="container">“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ante imperdiet lacus, semper libero habitant elit, donec sed. Lorem ipsum dolor sit amet, consectetur.”
                </blockquote>
                <cite>- Lorem Ipsum</cite>
            </div>
        ...
        <div class="page">
            <section class="description" id="3">
                ...
                <img src="HOME/peopleA.png" alt="peopleA" class="peopleA" />
                <div class="des_child">
                    <h2>We help new parents learn about the do's and dont's of raising a healthy child both physically and mentally.</h2>
                    <h2>Our highly researched content help students or interested people gain new knowledge about the effects a happy and healthy early childhood has on the personallity of a person</h2>
                    <h2>We provide an one stop guide to better parenting and family life to anyone interested.</h2>
                </div>
                <img src="HOME/peopleB.png" alt="peopleB" class="peopleB" />
            </section>
            ...
            <div class="end_taketest_button">
                    ...
                    <p class="check_out_btn">Go check out the assessment page !</p>
            </div>
            ...
            <h1 class="abt" id="about_us">ABOUT US</h1>
            <div class="about_us" >
