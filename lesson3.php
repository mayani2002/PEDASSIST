    ...
    <main>
        ...
        <div class="page">
            ...
            <section class="content">
                ...
                <p> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Constant stress drains precious energy the brain needs: in childhood, for healthy development; and in adulthood. In the areas of the brain dedicated to learning and reasoning, the
                    neural connections that comprise of brain architecture become weaker and fewer in number (because of stress ).
                </p>
                <p> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; In addition, people who have experienced serious early adversity, chronic personal discrimination, or inter-generational trauma are more likely to perceive and focus attention on
