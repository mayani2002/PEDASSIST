...
<nav class="sidenavbar" id="sidenavbar">
    ...
    <div class="nav_container_2">
        <ul>
            <li>
                <div class="dark_mode" id="dark_mode" onclick="enableDarkMode('dark_mode','light_mode')">
                    <img src="SVG/moon.svg" alt="" class="dark_mode_btn">
                    <span class="links_name">DARKMODE</span>
                </div>
            </li>
            <li>
                <div class="light_mode" id="light_mode" onclick="enableLightMode('dark_mode','light_mode')">
...
<header>
    ...
    <div class="box">
        <div class="hidden_mode_change_btn">
            <div class="dark_mode" id="dark_mode_header" onclick="enableDarkMode('dark_mode_header','light_mode_header')">
                <img src="SVG/moon.svg" alt="" class="dark_mode_btn mob_btn">
            </div>
            <div class="light_mode" id="light_mode_header" onclick="enableLightMode('dark_mode_header','light_mode_header')">
