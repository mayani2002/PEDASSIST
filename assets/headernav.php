...
<nav class="sidenavbar" id="sidenavbar">
    <div class="nav_container_1">
        ...
        <li class="navbtn" id="btn">
            <div class="nav_icon">
                <!-- <i data-feather="menu" class="btn"></i> -->
...
<header>
    <h3>PEDASSIST</h3>
    <div class="box">
        <div class="hidden_login_btn" onclick="displayLoginSignupForm('<?php echo $cookie;?>')">Login</div>
        <div class="profile_btn">
            <!-- <i data-feather="user"></i> -->
            <img src="SVG/profile_icon.svg" class="profile_btn_icon">
        </div>
    </div>
